...
[`VarQuantity`]: https://docs.rs/var_quantity/0.3.1/var_quantity/enum.VarQuantity.html
[`VarQuantity::Constant`]: https://docs.rs/var_quantity/0.3.1/var_quantity/enum.VarQuantity.html#variant.Constant
[`VarQuantity::Function`]: https://docs.rs/var_quantity/0.3.1/var_quantity/enum.VarQuantity.html#variant.Function
[`VarQuantity::get`]: https://docs.rs/var_quantity/0.3.1/var_quantity/enum.VarQuantity.html#method.get
[`QuantityFunction`]: https://docs.rs/var_quantity/0.3.1/var_quantity/struct.QuantityFunction.html
[`QuantityFunction::call`]: https://docs.rs/var_quantity/0.3.1/var_quantity/struct.QuantityFunction.html#method.call
[`QuantityFunction::new`]: https://docs.rs/var_quantity/0.3.1/var_quantity/struct.QuantityFunction.html#method.new
[`IsQuantityFunction`]: https://docs.rs/var_quantity/0.3.1/var_quantity/trait.IsQuantityFunction.html
[`IsQuantityFunction::call`]: https://docs.rs/var_quantity/0.3.1/var_quantity/trait.IsQuantityFunction.html#tymethod.call
[`filter_unary_function`]: https://docs.rs/var_quantity/0.3.1/var_quantity/fn.filter_unary_function.html
[`Polynomial`]: https://docs.rs/var_quantity/0.3.1/var_quantity/unary/struct.Polynomial.html
[`unary`]: https://docs.rs/var_quantity/0.3.1/var_quantity/unary.html
...
- Wrap the trait object in a [`QuantityFunction`]. Since [`IsQuantityFunction`]
works with dynamic quantities, it needs to be tested whether the output from
[`IsQuantityFunction::call`] can be converted to the statically typed quantity `T`
...
[`QuantityFunction::new`] and again in [`QuantityFunction::call`], see the
docstring of [`QuantityFunction`].
- Wrap the [`QuantityFunction`] in [`VarQuantity::Function`]. The purpose of this
...
[https://docs.rs/var_quantity/0.3.1/var_quantity/](https://docs.rs/var_quantity/0.3.1/var_quantity/).